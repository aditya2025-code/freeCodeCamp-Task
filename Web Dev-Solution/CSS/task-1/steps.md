...
CSS properties and values like this:
...
You change the properties of a link when the link has been visited by using a pseudo-selector that looks like
...
You change the properties of a link when the link is being clicked by using a pseudo-selector that looks like
